...
<div class="constitution">
    <h1 class="noUnderscore">GENTLEMEN'S COALITION CONSTITUTION</h1>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Immediate reduction of FAAB budget by 80% and loss of first two draft picks the following year</li>
            <li>Second Offense – 1 game suspension</li>
            <li>Third Offense – Dismissed from league</li>
        </ul>
    ...
    <div class="subBlock">
        <p>A total of 7 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion or an egregious mismatch of value (i.e. CMC for a backup TE). Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Wednesdays, after that each dropped player has two day waiver window.</p>

    <p>FAAB budgets will reset each for teams in playoffs and reset after the draft.</p>
    ...
    <h3 bind:this={twoTwo}>2.2 Rookie/Supplemental Drafts</h3>
    <p>Rookie drafts will consist of 6 round of drafting, with 1.5 minutes alotted for each pick. To make room for the incoming players, benches will be expanded by (6) spots. These spots will be removed in mid-August, at which point you will need to have cut the necessary players.</p>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical 1.0 PPR Scoring). The scoring system will never change without a majority league vote.</p>
    ...
    <ol>
        <li>Points For</li>
        <li>Cuervo H2H Record</li>
        <li>Cuervo Overall Record</li>
    ...
    <p>League dues are set at {dues}$. Dues are collected through Venmo, Paypal or Bank Transfer. Money should go to davidjamesmcmillan@gmail.com. Money is due by the end of Week 6 matchups. Failure to pay results in immediate suspension. Last place team pays for shipping of trophy to the winning team.  </p>
